...
let allChecks: [(String, () throws -> Void)] = [
    ...
    ("up/down produces the requested series", upDownProducesRequestedSeries),
    ("up/down has no floating-point drift", upDownHasNoFloatingPointDrift),
    ("up/down clamps uneven steps", upDownClampsUnevenSteps),
